...
List<ColorSchemesWithName> mySchemes() {
  return [
    ...
    ColorSchemesWithName(el.colorSchemeNameLoc.gray,
        ColorSchemes.lightDefaultColor, ColorSchemes.darkDefaultColor),
    ...
    ColorSchemesWithName(
        el.colorSchemeNameLoc.red, ColorSchemes.lightRed, ColorSchemes.darkRed),
