...
//     final query = request.uri.queryParameters;
//     final deviceSerialNo = query['deviceId'];
...
//         .where((pair) =>
//             pair.deviceId == deviceSerialNo &&
//             configsMap[pair.config.id] != null)
//         .toList();
...
//     final device = devices.firstWhereOrNull((d) => d.serialNo == pair.deviceId);
